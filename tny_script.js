...
/* window.alert("Welcome to Tulsa!"); FOR TESTING */
...
//let currentDay = new Date("May 23, 2018 14:35:05"); OLD
let currentDay = new Date();
let dateStr = currentDay.toLocaleDateString();
let timeStr = currentDay.toLocaleTimeString();

/* Display the current date and time */
/* document.getElementById("dateNow").innerHTML = "m/d/y<br />h:m:s"; OLD*/
document.getElementById("dateNow").innerHTML = dateStr + "<br />" + timeStr;

/* Calcutae the days until January 1st */
...
/* document.getElementById("days").textContent = "dd"; OLD */
